...
export default function Forget() {
  ...
  const ResetPass = () => {
    ...
    return (
      <div className="container-login">
        <h2 className="header-login"> Tạo mật khẩu mới</h2>
        <form>
          <div className="items">
          ...
          <div className="items">
            <Link to={`/login`} className="link-forgot">
              ...
              <label className="span-login">Hủy bỏ</label>
            </Link>
          </div>
        </form>
      </div>
  ...
  return (
    <div className="Login">
      ...
      {otpForm ? (
        <div className="container-login">
          <h2 className="header-login"> Quên mật khẩu?</h2>
          <form action="">
            <div className="items">
              <div className="input-container">
                <span className="icon-input">
            ...
            <div className="item-login">
              <Link to={`/login`} className="link-forgot">
                <ArrowBackIosIcon className="icon-forgot" />
                <label className="span-login">Quay lại Đăng nhập</label>
              </Link>
            </div>
          </form>
        </div>
