  ...
  const validateForm = () => {
    ...
    if (inputField.newPassword === "") {
      ...
      setErrField((prevState) => ({
        ...prevState,
        newPasswordErr: "Vui lòng nhập mật khẩu mới",
      }));
    }
    ...
    if (inputField.oldPassword === "") {
      ...
      setErrField((prevState) => ({
        ...prevState,
        oldPasswordErr: "Vui lòng nhập mật khẩu cũ",
      }));
    }
    ...
    if (
      ...
      setErrField((prevState) => ({
        ...prevState,
        ConfirmErr: "Mật khẩu xác nhận của bạn không khớp!",
      }));
    }
    Clear();
    return formValid;
      ...
      <div className="right-container">
        ...
        <div className="bottom-profile">
          ...
          <div className="ChangePassword">
            <ToastContainer />
            <div className="header-change">Thay đổi mật khẩu của bạn</div>
